...
import { Actions, ModuleData, Message } from '../../common/types';

export const processMessage = (action: Actions, data: ModuleData | null): string => {
...
export class HotModuleServer {
  ...
  private sendBroadcast(action: Actions, data: ModuleData | null): void {
